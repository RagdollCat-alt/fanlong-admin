...
function refreshLiveData(){
  fetch('api/refresh.php')
    ...
    .then(data=>{
      ...
      if(data.families   !== undefined && document.getElementById('stat-families'))   document.getElementById('stat-families').textContent   = data.families;
      if(data.fund_types !== undefined && document.getElementById('stat-fund'))       document.getElementById('stat-fund').textContent       = data.fund_types;
    })
    .catch(()=>{});
}
