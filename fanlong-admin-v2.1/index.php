...
$cards = [
  ...
  ['id'=>'stat-families', 'icon'=>'fas fa-flag',         'color'=>'oklch(0.63 0.14 185)',  'bg'=>'oklch(0.63 0.14 185 / 0.12)', 'val'=>$stat['families'],    'label'=>'活跃家族',  'link'=>'families.php'],
  ['id'=>'stat-fund',     'icon'=>'fas fa-chart-line',   'color'=>'oklch(0.80 0.15 83)',   'bg'=>'oklch(0.80 0.15 83 / 0.12)',  'val'=>$stat['fund_types'],  'label'=>'活跃基金',  'link'=>'fund_types.php'],
  ['id'=>'stat-holdings', 'icon'=>'fas fa-wallet',       'color'=>'oklch(0.68 0.13 260)',  'bg'=>'oklch(0.68 0.13 260 / 0.12)', 'val'=>$stat['holdings'],    'label'=>'基金持仓',  'link'=>'fund_holdings.php'],
];
foreach($cards as $c): ?>
        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            ...
            <tr>
              ...
              <td style="color:var(--t-2)"><?php echo $item['price']; ?> <?php echo htmlspecialchars($item['currency'] ?? '虞元'); ?></td>
              <td>
