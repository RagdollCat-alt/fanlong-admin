...
$mgmt_links = [
    ...
    'admins'=>'admins.php','fund_types'=>'fund_types.php','fund_holdings'=>'fund_holdings.php',
    'families'=>'families.php','family_rules'=>'family_rules.php',
    'login_logs'=>'login_logs.php','admin_logs'=>'admin_logs.php',
    'drama_archives'=>'drama_archives.php','history_stats'=>'history_stats.php',
    'item_instances'=>'item_instances.php','auction_history'=>'auction_history.php',
    'family_logs'=>'family_logs.php',
];
