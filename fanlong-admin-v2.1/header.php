...
.btn-outline-secondary { border-color: var(--b-weak) !important; color: var(--t-2) !important; }
...
<div id="sidebar">
  ...
  <nav class="sb-nav" aria-label="主导航">
    ...
    <ul class="list-unstyled mb-0">
      ...
      <?php endif; ?>
      <?php if(can('families')): ?>
      <li class="sb-item"><a href="families.php" class="<?php echo $cur==='families.php'?'active':''; ?>">
        <i class="fas fa-flag sb-icon"></i><span class="sb-label">家族管理</span></a></li>
      <?php endif; ?>
      <?php if(can('family_rules')): ?>
      <li class="sb-item"><a href="family_rules.php" class="<?php echo $cur==='family_rules.php'?'active':''; ?>">
        <i class="fas fa-scale-balanced sb-icon"></i><span class="sb-label">评分规则</span></a></li>
      <?php endif; ?>
      ...
      <li class="sb-item"><a href="fund_types.php" class="<?php echo $cur==='fund_types.php'?'active':''; ?>">
        <i class="fas fa-chart-line sb-icon"></i><span class="sb-label">基金产品</span></a></li>
      <?php endif; ?>
      <?php if(can('fund_holdings')): ?>
      <li class="sb-item"><a href="fund_holdings.php" class="<?php echo $cur==='fund_holdings.php'?'active':''; ?>">
        <i class="fas fa-wallet sb-icon"></i><span class="sb-label">基金持仓</span></a></li>
      <?php endif; ?>
      ...
      <li class="sb-item"><a href="auction_history.php" class="<?php echo $cur==='auction_history.php'?'active':''; ?>">
        <i class="fas fa-gavel sb-icon"></i><span class="sb-label">竞拍历史</span></a></li>
      <?php endif; ?>
      <?php if(can('family_logs')): ?>
      <li class="sb-item"><a href="family_logs.php" class="<?php echo $cur==='family_logs.php'?'active':''; ?>">
        <i class="fas fa-scroll sb-icon"></i><span class="sb-label">家族日志</span></a></li>
      <?php endif; ?>
    </ul>
    <?php endif; ?>
